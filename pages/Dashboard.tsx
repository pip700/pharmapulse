...
import { DollarSign, AlertTriangle, TrendingUp, Package, Lightbulb } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <tbody className="divide-y divide-gray-50">
                {sales.slice().reverse().slice(0, 5).map((sale) => (
                  <tr key={sale.id} className="text-sm">
                    ...
                    <td className="py-3 text-right font-medium text-teal-600">${sale.totalAmount.toFixed(2)}</td>
                  </tr>
                ))}
                {sales.length === 0 && (
                  <tr>
        ...
        {/* Local Insights Card (Replaces AI) */}
